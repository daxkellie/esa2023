---
title: "<span style='font-size: 3.8rem;'> How to make a shareable code workflow for reproducible and efficient science </span><br>"
...
::: {.column width="60%"}
::: {style="font-size: 70%;"}
<br> <b>Dax Kellie</b><br>Data Analyst & Science Lead<br>Science & Decision Support \| ALA <br>e: dax.kellie\@csiro.au<br> {{< fa brands twitter size=lg >}}: [\@daxkellie](https://twitter.com/daxkellie)<br> gh: [\@daxkellie](https://github.com/daxkellie) <br> <br> <b>Science & Decision Support team</b><br> Martin Westgate, Fonti Kar, Olivia Torresan<br> Shandiya Balasubramaniam, Amanda Buyan<br>Juliet Seers, Callum Waite<br> <br> <em>These slides were made using Quarto & RStudio</em>
:::
:::
