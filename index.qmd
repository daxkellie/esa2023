...
# 1. Make your work environment shareable {background-color="#5D2E46" transition="slide" style="color: #ffffff; font-size: 120%"}
...
## Rendered documents show workflow from start to finish {background-color="#FBF2EF" style="font-size: 80%"}

Documenting results, including middle steps

  *  allows you to quickly reference work
  *  lets others see data wrangling steps more clearly

## Rendered output from start to finish {background-color="#FBF2EF" style="font-size: 80%"}
...
# Summary
  ...
  *  Make your work environment shareable: 
    - Use an online repository (GitHub)
    - Create safe links (the {here} package)
    - Save package versions (the {renv} package)
  *  Readable code, Readable notes
    - Simple, clear object & function names
    - Clear notes with interpretations
  *  Render code output
    - Save rendered files somewhere findable/shareable
    - Use Quarto
